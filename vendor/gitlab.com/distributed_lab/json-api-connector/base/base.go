...
func (c *Connector) PostJSON(endpoint *url.URL, req interface{}, ctx context.Context) (statusCode int, response []byte, err error) {
...
func (c *Connector) Post(endpoint *url.URL, body io.Reader, ctx context.Context) (statusCode int, response []byte, err error) {
...
func (c *Connector) PatchJSON(endpoint *url.URL, req interface{}, ctx context.Context) (statusCode int, response []byte, err error) {
	reqBB, err := json.Marshal(req)
	if err != nil {
		return 0, nil, errors.Wrap(err, "Failed to marshal request into JSON bytes")
	}
...
func (c *Connector) Patch(endpoint *url.URL, body io.Reader, ctx context.Context) (statusCode int, response []byte, err error) {
...
func (c *Connector) PutJSON(endpoint *url.URL, body io.Reader) (response []byte, err error) {
	fullEndpoint, err := c.client.Resolve(endpoint)
	if err != nil {
		return nil, err
	}
